...
it('env:encrypt-value encrypts a key in place and env:decrypt-value reverses it', function () {
    ...
    $this->artisan('laranail::env-kit.encrypt-value', ['key' => 'SECRET'])
    ...
    $this->artisan('laranail::env-kit.decrypt-value', ['key' => 'SECRET'])
...
it('env:encrypt-value errors on a missing key', function () {
    ...
    $this->artisan('laranail::env-kit.encrypt-value', ['key' => 'NOPE'])
